...
import { Grid, GridColumn as Column, GridToolbar, GridSearchBox, GridCellProps } from '@progress/kendo-react-grid';
...
const DoctorsAdmin: React.FC = () => {
    ...
    const grid = (
        <Grid
            style={{ height: 'calc(100vh - 200px)', minHeight: '470px' }}
        ...
        >
            ...
            <Column field="experience" title="Years of Experience" width="150px" />
            <Column field="rating" title="Rating" cell={RatingCell} width="120px" />
            <Column field="patients" title="Total Patients" width="150px" />
            <Column field="availability" title="Availability" width="150px" />
                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            ...
                            <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                                <Link href="/admin/doctors" className="border-blue-500 text-gray-900 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                                    Doctors
                                </Link>
